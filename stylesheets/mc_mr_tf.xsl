...
<xsl:template match="Question[Type=1 or Type=2 or Type=4]">
                            ...
                            <flow_label class="Block">
                                <response_label ident="TLM_QUES_{ancestor::Question/child::ID}_RESP_{id}">
                                    <flow_mat>
                                        <material>
                                            <xsl:choose>
                                                <xsl:when test="responsetype = 'text/html'">
                                                    <mattext texttype="text/html">&lt;p&gt;<xsl:value-of select="text" />&lt;/p&gt;</mattext>
                                                </xsl:when>
                                                <xsl:when test="responsetype = 'text/plain'">
